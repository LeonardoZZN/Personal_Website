...
inline SkinMethod getDefaultSkinningMethod() { return LBS; }
...
public:
  ...
  // Skinning method modifier
  // input: the applied skinning method input by the user
  void setSkinMethod(SkinMethod SkinMethodInput) {
     skinMethodUsed = SkinMethodInput;
  }
